import { An as forwardRef, E as DOCUMENT, G as Injector, O as DestroyRef, Ri as signal, S as CSP_NONCE, W as InjectionToken, _ as untracked, b as APP_ID, ba as SIGNAL, c as computed, f as isInParamsFunction, g as setInParamsFunction, ia as ɵɵdefineInjectable, kn as formatRuntimeError, m as resource, ni as makeEnvironmentProviders, p as linkedSignal, s as chain, ut as RuntimeError, xi as runInInjectionContext, yn as effect, yr as inject } from "./_resource-chunk-Bs197SVl.js";
import { I as debounced, L as declareExperimentalWebMcpTool, Po as ɵɵlistener, Sn as Input, T as afterRenderEffect, Va as ɵɵdefineDirective, Wi as ɵɵControlFeature, Wn as Renderer2, X as input, Yi as ɵɵProvidersFeature, fn as ElementRef, ii as isPromise, ki as setClassMetadata, po as ɵɵgetInheritedFactory, un as Directive, xn as Injectable } from "./core-7astvhVk.js";
import { n as httpResource } from "./http-B3BSuI8A.js";
...
var FieldValidationState = class {
	...
	errorSummary = computed(() => {
		return this.node.structure.reduceChildren(this.errors(), (child, result) => [...result, ...child.errorSummary()]);
	}, {
