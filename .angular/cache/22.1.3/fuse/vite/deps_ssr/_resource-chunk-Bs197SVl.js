...
//#endregion
export { NG_PIPE_DEF as $, viewAttachedToContainer as $i, getLViewParent as $n, leaveSkipHydrationBlock as $r, assertParentView as $t, EMPTY_OBJ as A, setActiveConsumer as Aa, setCurrentTNodeAsNotParent as Ai, forwardRef as An, isEnvironmentProviders as Ar, assertFirstUpdatePass as At, INJECTOR$1 as B, store as Bi, getCurrentDirectiveDef as Bn, isProjectionTNode as Br, assertLContainer as Bt, ChangeDetectionScheduler as C, consumerBeforeComputation as Ca, scheduleCallbackWithMicrotask as Ci, emitProviderConfiguredEvent as Cn, isComponentDef as Cr, arraySplice as Ct, DOC_PAGE_BASE_URL as D, createSignal as Da, setCurrentDirectiveIndex as Di, fillProperties as Dn, isCurrentTNodeParent as Dr, assertElement as Dt, DOCUMENT as E, createComputed as Ea, setBindingRootForHostBindings as Ei, errorHandlerEnvironmentInitializer as En, isCreationMode as Er, assertDomNode as Et, EnvironmentInjector as F, setIsInCheckNoChangesMode as Fi, getClosureSafeProperty as Fn, isInInjectionContext as Fr, assertInInjectionContext as Ft, Injector as G, throwError as Gi, getCurrentTNodePlaceholderOk as Gn, isStandalone as Gr, assertNotDefined as Gt, INJECTOR_SCOPE as H, storeLViewOnDestroy as Hi, getCurrentParentTNode as Hn, isRootView as Hr, assertLessThan as Ht, ErrorHandler as I, setIsRefreshingViews as Ii, getComponentDef as In, isInSkipHydrationBlock as Ir, assertIndexInDeclRange as It, NG_DIR_DEF as J, unwrapLView as Ji, getElementDepthCount as Jn, keyValueArrayGet as Jr, assertNotReactive as Jt, MATH_ML_NAMESPACE as K, throwProviderNotFoundError as Ki, getDirectiveDef as Kn, isTypeProvider as Kr, assertNotEqual as Kt, EventEmitter as L, setSelectedIndex as Li, getComponentLViewByIndex as Ln, isInjectable as Lr, assertIndexInExpandoRange as Lt, ERROR_DETAILS_PAGE_BASE_URL as M, signalSetFn as Ma, setInjectImplementation as Mi, getBindingIndex as Mn, isForwardRef as Mr, assertGreaterThan as Mt, EffectRefImpl as N, setInjectorProfiler as Ni, getBindingRoot as Nn, isInCheckNoChangesMode as Nr, assertGreaterThanOrEqual as Nt, DestroyRef as O, getActiveConsumer as Oa, setCurrentQueryIndex as Oi, flatten as On, isDestroyed as Or, assertEqual as Ot, EffectScheduler as P, setInjectorProfilerContext as Pi, getBindingsEnabled as Pn, isInI18nBlock as Pr, assertHasParent as Pt, NG_MOD_DEF as Q, viewAttachedToChangeDetector as Qi, getLView as Qn, leaveDI as Qr, assertOneOf as Qt, IMAGE_CONFIG as R, signal as Ri, getConstant as Rn, isLContainer as Rr, assertIndexInRange as Rt, CSP_NONCE as S, consumerAfterComputation as Sa, runInInjectorProfilerContext as Si, emitInstanceCreatedByInjectorEvent as Sn, isClassProvider as Sr, arrayInsert2 as St, DEBUG_TASK_TRACKER as T, consumerPollProducersForChange as Ta, setBindingIndex as Ti, enterView as Tn, isContentQueryHost as Tr, assertDirectiveDef as Tt, INTERNAL_APPLICATION_ERROR_HANDLER as U, stringify as Ui, getCurrentQueryIndex as Un, isSignal as Ur, assertNgModuleType as Ut, INJECTOR_DEF_TYPES as V, storeCleanupWithContext as Vi, getCurrentDirectiveIndex as Vn, isRefreshingViews as Vr, assertLView as Vt, InjectionToken as W, stringifyForError as Wi, getCurrentTNode as Wn, isSkipHydrationRootTNode as Wr, assertNodeInjector as Wt, NG_FACTORY_DEF as X, updateAncestorTraversalFlagsOnAttach as Xi, getInjectableDef as Xn, keyValueArraySet as Xr, assertNumber as Xt, NG_ELEMENT_ID as Y, unwrapRNode as Yi, getFactoryDef as Yn, keyValueArrayIndexOf as Yr, assertNotSame as Yt, NG_INJ_DEF as Z, validAppIdInitializer as Zi, getInjectorDef as Zn, lastNodeWasCreated as Zr, assertNumberInRange as Zt, untracked as _, linkedSignalUpdateFn as _a, requiresRefreshOrTraversal as _i, decreaseElementDepthCount as _n, incrementBindingIndex as _r, ZONELESS_ENABLED as _t, ResourceParamsStatus as a, ɵɵdefineInjector as aa, markViewForRefresh as ai, assertTNodeCreationIndex as an, getNgModuleDefOrThrow as ar, PLATFORM_INITIALIZER as at, APP_ID as b, SIGNAL as ba, retrieveTransferredState as bi, emitInjectEvent as bn, injectRootLimpMode as br, angularZoneInstanceIdProperty as bt, computed as c, ɵɵinject as ca, nextContextImpl as ci, attachInjectFlag as cn, getOrCreateTViewCleanup as cr, PendingTasksInternal as ct, invalidResourceCreationInParams as d, ɵɵnamespaceMathML as da, provideEnvironmentInitializer as di, convertToBitFlags as dn, getSelectedTNode as dr, SCHEDULE_IN_ROOT_ZONE as dt, walkProviderTree as ea, leaveView as ei, assertProjectionSlots as en, getNamespace as er, NG_PROV_DEF as et, isInParamsFunction as f, ɵɵnamespaceSVG as fa, providerToFactory as fi, createInjector as fn, getTNode as fr, SecurityContext as ft, setInParamsFunction as g, linkedSignalSetFn as ga, renderStringify as gi, debugStringifyTypeForError as gn, increaseElementDepthCount as gr, XSS_SECURITY_URL as gt, rethrowFatalErrors as h, createLinkedSignal as ha, removeLViewOnDestroy as hi, cyclicDependencyErrorWithDetails as hn, importProvidersFrom as hr, Version as ht, ResourceImpl as i, ɵɵdefineInjectable as ia, markAncestorsForTraversal as ii, assertTNode as in, getNgModuleDef as ir, PLATFORM_ID as it, ENVIRONMENT_INITIALIZER as j, setThrowInvalidWriteToSignalError as ja, setInI18nBlock as ji, getAllSpecialProviders as jn, isExhaustiveCheckNoChanges as jr, assertFunction as jt, EMPTY_ARRAY as k, producerAccessed as ka, setCurrentTNode as ki, formatRuntimeError as kn, isDirectiveHost as kr, assertFirstCreatePass as kt, encapsulateResourceError as l, ɵɵinvalidFactoryDep as la, promiseWithResolvers as li, checkSecurityContext as ln, getPipeDef as lr, R3Injector as lt, resource as m, ɵɵrestoreView as ma, removeFromArray as mi, cyclicDependencyError as mn, hasI18n as mr, VERSION as mt, OutputEmitterRef as n, wasLastNodeCreated as na, makeEnvironmentProviders as ni, assertString as nn, getNativeByTNode as nr, NoopNgZone as nt, ResourceValueError as o, ɵɵdisableBindings as oa, newArray as oi, assertTNodeForLView as on, getNullInjector as or, PROVIDED_ZONELESS as ot, linkedSignal as p, ɵɵresetView as pa, registerSpecialProvider as pi, createInjectorWithoutInjectorInstances as pn, getTView as pr, TransferState as pt, NG_COMP_DEF as q, truncateMiddle as qi, getDirectiveDefOrThrow as qn, isWritableSignal as qr, assertNotInReactiveContext as qt, ResourceDependencyError as r, ɵunwrapWritableSignal as ra, makeStateKey as ri, assertTIcu as rn, getNativeByTNodeOrNull as rr, NullInjector as rt, chain as s, ɵɵenableBindings as sa, nextBindingIndex as si, assertTNodeForTView as sn, getOrCreateLViewCleanup as sr, PendingTasks as st, CACHE_ACTIVE as t, walkUpViews as ta, load as ti, assertSame as tn, getNativeByIndex as tr, NgZone as tt, getOutputDestroyRef as u, ɵɵnamespaceHTML as ua, provideBrowserGlobalErrorListeners as ui, concatStringsWithSpace as un, getSelectedIndex as ur, RuntimeError as ut, require_operators as v, setCurrentInjector as va, resetPreOrderHookFlags as vi, deepForEach as vn, initNgDevMode as vr, _global as vt, CheckNoChangesMode as w, consumerDestroy as wa, scheduleCallbackWithRafRace as wi, enterDI as wn, isComponentHost as wr, assertDefined as wt, CONTAINER_HEADER_OFFSET as x, SIGNAL_NODE as xa, runInInjectionContext as xi, emitInjectorToCreateInstanceEvent as xn, internalImportProvidersFrom as xr, arrayEquals as xt, ANIMATION_MODULE_TYPE as y, REACTIVE_NODE as ya, resolveForwardRef as yi, effect as yn, inject as yr, addToArray as yt, IMAGE_CONFIG_DEFAULTS as z, signalAsReadonlyFn as zi, getContextLView as zn, isLView as zr, assertInjectImplementationNotEqual as zt };
