import { E as DOCUMENT, G as Injector, L as EventEmitter, Ri as signal, W as InjectionToken, aa as ɵɵdefineInjector, ma as ɵɵrestoreView, pa as ɵɵresetView, tt as NgZone, v as require_operators, yr as inject } from "./_resource-chunk-Bs197SVl.js";
...
import { C as InteractivityChecker, M as FocusMonitor, b as FocusTrapFactory } from "./a11y-2dXFx_gi.js";
...
import { d as ViewportRuler, i as CdkScrollableModule, r as CdkScrollable } from "./scrolling-CdrI-2b0.js";
...
var MatDrawerContent = class MatDrawerContent extends CdkScrollable {
	...
	_drawerToggled(drawer) {
		if (drawer.opened) this._ngZone.runOutsideAngular(() => {
			drawer._animationEnd.pipe((0, import_operators.delay)(50), (0, import_operators.take)(1)).subscribe(() => this._updateInert());
		});
...
var MatDrawer = class MatDrawer {
	...
	_openedVia = null;
	_animationStarted = new import_cjs.Subject();
	_animationEnd = new import_cjs.Subject();
	...
	_content;
	_modeChanged = new import_cjs.Subject();
...
var MatDrawerContainer = class MatDrawerContainer {
	...
	_right = null;
	_destroyed = new import_cjs.Subject();
	_doCheckSubject = new import_cjs.Subject();
	_contentMargins = {
		left: null,
		right: null
	};
	_contentMarginChanges = new import_cjs.Subject();
	get scrollable() {
	...
	_watchDrawerToggle(drawer) {
		...
		if (drawer.mode !== "side") drawer.openedChange.pipe((0, import_operators.takeUntil)(this._drawers.changes)).subscribe(() => this._setContainerClass(drawer.opened));
	}
	...
	_watchDrawerMode(drawer) {
		drawer._modeChanged.pipe((0, import_operators.takeUntil)((0, import_cjs.merge)(this._drawers.changes, this._destroyed))).subscribe(() => {
			this.updateContentMargins();
			this._changeDetectorRef.markForCheck();
		});
	}
