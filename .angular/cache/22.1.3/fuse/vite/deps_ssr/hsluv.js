//#region node_modules/hsluv/dist/hsluv.mjs
var Hsluv = class Hsluv {
	constructor() {
		this.hex = "#000000";
		this.rgb_r = 0;
		this.rgb_g = 0;
	...
	static fromLinear(c) {
		...
		else return 1.055 * Math.pow(c, 1 / 2.4) - .055;
	}
	static toLinear(c) {
		if (c > .04045) return Math.pow((c + .055) / 1.055, 2.4);
		else return c / 12.92;
	}
	static yToL(Y) {
	...
	rgbToXyz() {
		...
		this.xyz_x = .41239079926595 * lr + .35758433938387 * lg + .18048078840183 * lb;
		this.xyz_y = .21263900587151 * lr + .71516867876775 * lg + .072192315360733 * lb;
		this.xyz_z = .019330818715591 * lr + .11919477979462 * lg + .95053215224966 * lb;
	}
	xyzToLuv() {
...
Hsluv.refY = 1;
Hsluv.refU = .19783000664283;
Hsluv.refV = .46831999493879;
Hsluv.kappa = 903.2962962;
Hsluv.epsilon = .0088564516;
Hsluv.m_r0 = 3.240969941904521;
Hsluv.m_r1 = -1.537383177570093;
Hsluv.m_r2 = -.498610760293;
Hsluv.m_g0 = -.96924363628087;
Hsluv.m_g1 = 1.87596750150772;
Hsluv.m_g2 = .041555057407175;
Hsluv.m_b0 = .055630079696993;
Hsluv.m_b1 = -.20397695888897;
