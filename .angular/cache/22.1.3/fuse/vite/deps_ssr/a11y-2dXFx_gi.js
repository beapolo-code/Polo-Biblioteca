import { E as DOCUMENT, G as Injector, L as EventEmitter, Ri as signal, Ur as isSignal, W as InjectionToken, aa as ɵɵdefineInjector, b as APP_ID, tt as NgZone, v as require_operators, yn as effect, yr as inject } from "./_resource-chunk-Bs197SVl.js";
import { Gn as RendererFactory2, Ha as ɵɵdefineNgModule, Hn as QueryList, Ji as ɵɵNgOnChangesFeature, Nn as NgModule, O as booleanAttribute, Sn as Input, Va as ɵɵdefineDirective, Wa as ɵɵdefineService, Zn as Service, fn as ElementRef, ki as setClassMetadata, un as Directive, vr as afterNextRender, zn as Output } from "./core-7astvhVk.js";
...
import { i as _getShadowRoot, n as _getEventTarget, r as _getFocusedElementPierceShadowDom } from "./_id-generator-chunk-CegWFmGw.js";
import { t as Platform } from "./_platform-chunk-DETPA5Z7.js";
import { n as coerceElement, r as coerceNumberProperty } from "./_element-chunk-Dra2rBy8.js";
import { t as _CdkPrivateStyleLoader } from "./_style-loader-chunk-CarLTVtR.js";
import { n as _setInnerHtml, t as _VisuallyHiddenLoader } from "./private-B9Wxp0l6.js";
import { t as BreakpointObserver } from "./_breakpoints-observer-chunk-BIvIL4Yo.js";
import { r as DomSanitizer } from "./platform-browser-B1uE8TK1.js";
...
function coerceObservable(data) {
	if (!(0, import_cjs.isObservable)(data)) return (0, import_cjs.of)(data);
	return data;
}
//#endregion
...
var TreeKeyManager = class {
	...
	constructor(items, config) {
		...
		} else if ((0, import_cjs.isObservable)(items)) items.subscribe((newItems) => this._itemsChanged(newItems));
		else {
			this._items = items;
	...
	_expandCurrentItem() {
		...
		else coerceObservable(this._activeItem.getChildren()).pipe((0, import_operators.take)(1)).subscribe((children) => {
	...
	_expandAllItemsAtCurrentItemLevel() {
		...
		const parent = this._activeItem.getParent();
		let itemsToExpand;
		if (!parent) itemsToExpand = (0, import_cjs.of)(this._items.filter((item) => item.getParent() === null));
		else itemsToExpand = coerceObservable(parent.getChildren());
		itemsToExpand.pipe((0, import_operators.take)(1)).subscribe((items) => {
...
//#endregion
export { CdkMonitorFocus as A, InteractivityChecker as C, LiveAnnouncer as D, LIVE_ANNOUNCER_ELEMENT_TOKEN as E, INPUT_MODALITY_DETECTOR_OPTIONS as F, InputModalityDetector as I, normalizePassiveListenerOptions as L, FocusMonitor as M, FocusMonitorDetectionMode as N, CdkObserveContent as O, INPUT_MODALITY_DETECTOR_DEFAULT_OPTIONS as P, HighContrastModeDetector as S, LIVE_ANNOUNCER_DEFAULT_OPTIONS as T, CdkAriaLive as _, FOCUS_TRAP_INERT_STRATEGY as a, FocusTrapFactory as b, addAriaReferencedId as c, TREE_KEY_MANAGER as d, TreeKeyManager as f, A11yModule as g, ListKeyManager as h, EventListenerFocusTrapInertStrategy as i, FOCUS_MONITOR_DEFAULT_OPTIONS as j, ObserversModule as k, getAriaReferenceIds as l, ActiveDescendantKeyManager as m, ConfigurableFocusTrap as n, NOOP_TREE_KEY_MANAGER_FACTORY_PROVIDER as o, FocusKeyManager as p, ConfigurableFocusTrapFactory as r, NoopTreeKeyManager as s, AriaDescriber as t, removeAriaReferencedId as u, CdkTrapFocus as v, IsFocusableConfig as w, HighContrastMode as x, FocusTrap as y };
