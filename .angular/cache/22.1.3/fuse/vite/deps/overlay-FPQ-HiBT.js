import { I as EventEmitter, P as EnvironmentInjector, T as DOCUMENT, U as InjectionToken, W as Injector, et as NgZone, sa as ɵɵdefineInjector, v as ANIMATION_MODULE_TYPE, xr as inject } from "./_resource-chunk-C-Y-Fu3B.js";
import { Ba as ɵɵdefineComponent, Gn as RendererFactory2, Ha as ɵɵdefineNgModule, Ji as ɵɵNgOnChangesFeature, Jt as Component, Nn as NgModule, O as booleanAttribute, Sn as Input, Va as ɵɵdefineDirective, Vt as ApplicationRef, Wa as ɵɵdefineService, Wn as Renderer2, Zn as Service, fn as ElementRef, fr as ViewContainerRef, ir as TemplateRef, ki as setClassMetadata, pr as ViewEncapsulation, un as Directive, vr as afterNextRender, zn as Output } from "./core-6q3cy1tM.js";
import { Qn as Subject, Xt as filter, h as takeWhile, ur as Subscription } from "./esm5-Cc635x76.js";
import { n as _getEventTarget, t as _IdGenerator } from "./_id-generator-chunk-DNit0CSO.js";
import { jt as Location } from "./common-BW30PdCZ.js";
...
import { d as ViewportRuler, g as supportsScrollBehavior, l as ScrollDispatcher, u as ScrollingModule } from "./scrolling-DnPVSn-1.js";
import { a as DomPortalOutlet, o as PortalModule, s as TemplatePortal } from "./portal-BitIpHHV.js";
...
//#endregion
export { createNoopScrollStrategy as A, STANDARD_DROPDOWN_BELOW_POSITIONS as C, createCloseScrollStrategy as D, createBlockScrollStrategy as E, createRepositionScrollStrategy as M, validateHorizontalPosition as N, createFlexibleConnectedPositionStrategy as O, validateVerticalPosition as P, STANDARD_DROPDOWN_ADJACENT_POSITIONS as S, ScrollingVisibility as T, OverlayModule as _, CdkOverlayOrigin as a, OverlayRef as b, ConnectionPositionPair as c, NoopScrollStrategy as d, OVERLAY_DEFAULT_CONFIG as f, OverlayKeyboardDispatcher as g, OverlayContainer as h, CdkConnectedOverlay as i, createOverlayRef as j, createGlobalPositionStrategy as k, FlexibleConnectedPositionStrategy as l, OverlayConfig as m, BlockScrollStrategy as n, CloseScrollStrategy as o, Overlay as p, CDK_CONNECTED_OVERLAY_DEFAULT_CONFIG as r, ConnectedOverlayPositionChange as s, FullscreenOverlayContainer as t, GlobalPositionStrategy as u, OverlayOutsideClickDispatcher as v, ScrollStrategyOptions as w, RepositionScrollStrategy as x, OverlayPositionBuilder as y };
