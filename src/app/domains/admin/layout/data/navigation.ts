  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: 'Libros',
        icon: 'book',
        route: '/pages/my-route', // <- Restaurado exactamente como lo tenías antes
        activeOptions: { exact: false },
      },
      {
        id: 'pages/book-components',
        label: 'Book Components',
        icon: 'book-open',
        route: '/pages/books', // <- Nuevo apartado apuntando a la ruta de los libros
        activeOptions: { exact: false },
      },
    ],
  },
